...
export default function Edit({ isOpen, onClose, project }: EditModalProps) {
    ...
    const [isSaving, setIsSaving] = useState<'idle' | 'saving' | 'success'>('idle');
    ...
    return (
        <>
            ...
            {isSaving !== 'idle' && (
                <div className="fixed bottom-6 right-6 bg-gray-900 text-white shadow-xl px-5 py-3 rounded-lg justify-center flex items-center gap-3 z-15 animate-in fade-in slide-in-from-bottom-5 w-50">
                    {isSaving === 'saving' ? (
                        <>
                    ...
                    <div className="relative max-w-150 mx-auto px-4 py-12 w-full h-auto items-center transition-all flex flex-1 z-10 ">
                        ...
                        <div className="p-4 border border-gray-600 bg-gray-50 rounded shrink-0 w-full  h-full">
                            <form
                                ...
                                <label htmlFor="link" >
                                    Link:
                                    <input id="link" name="link" type="url" defaultValue={project.link} placeholder="Name of project" required />
                                </label>
                                <Submit />
                            </form>
                        </div>
